...
@interface InvitedDetailViewController : UIViewController<NSURLConnectionDelegate,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UITextViewDelegate,NSURLSessionDelegate>
...
//@property (weak, nonatomic) IBOutlet UILabel *keynotetitle;


@property(nonatomic,retain)NSString *imgstr,*namestr,*universitystr,*sess_namestr,*abstractstr,*indxpath,*success,*message,*keynotetiltestr,*temptalkname,*tempSpeakerName,*tempTalkid,*liked,*added;
...
@property(nonatomic,retain)NSString *tempname,*tempName,*tempdate,*temptime,*tempnotify_id,*tempimg,*sessionidstr,*locationstr,*starttimestr,*endtimestr;
