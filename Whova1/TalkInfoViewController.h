...
@interface TalkInfoViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,NSURLSessionDelegate,UITextViewDelegate,NSURLConnectionDelegate>
...
@property(nonatomic,retain)NSString *imgstr,*namestr,*universitystr,*sess_namestr,*abstractstr,*indxpath,*success,*message,*keynotetiltestr,*tempname,*tempName,*tempdate,*temptime,*tempnotify_id,*tempimg,*talkidstr,*locationstr,*starttimestr,*endtimestr,*tempsessionid,*tempcomment,*addedStr,*liked,*added;
