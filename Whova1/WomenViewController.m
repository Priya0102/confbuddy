...
#import "WomenCommentTableViewCell.h"
#import "WomenComment.h"
    ...
    NSURLSessionDataTask *task4=[defaultSession dataTaskWithRequest:urlRequest completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error)
                                 {
                                     ...
                                     else
                                     {
                                         ...
                                         for(NSDictionary *temp in arr){
                                             WomenComment *f=[[WomenComment alloc]init];
                                             f.name=temp[@"user"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView==self.tableview) {
        ...
        WomenTableViewCell *cell=[_tableview dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        ...
        WomenCommentTableViewCell *cell = [self.tableview2 dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
        
        WomenComment *ktemp=[_commentarray objectAtIndex:indexPath.row];
...
-(void)addSession{
       ...
       // NSURL * url = [NSURL URLWithString:@"http://192.168.1.100/phpmyadmin/itherm/add_to_schedule.php"];
